...
var reserved = []string{
	/* keywords */
	"any", "break", "comparable", "default", "func", "interface", "select", "case", "defer", "go", "map", "struct", "chan", "else", "goto", "package", "switch", "const", "fallthrough", "if", "range", "type", "continue", "for", "import", "return", "var",
	/* predeclared */
...
func IsReservedWord(alias string) bool {
	return slices.Contains(reserved, alias)
}
